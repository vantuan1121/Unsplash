...
import info from '@/assets/img/imgmenu/Film/info.avif';
...
<template>
  ...
  <div class="flex justify-center gap-7">
    ...
    <div class="mt-[50px] border-0 w-[15cm]">
      ...
      <div class="mt-[25px]">
        This category celebrates film's timeless beauty, capturing moments with rich<br>
        textures and unique colors that define analog photography.
      </div>
    </div>
