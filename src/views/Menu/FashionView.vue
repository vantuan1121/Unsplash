...
import info from '@/assets/img/imgmenu/Fashion_Beauty/info.avif'
</script>
...
<template>
  ...
  <div class="flex justify-center gap-7">
    ...
    <div class="mt-[50px] border-0 w-[15cm]">
      ...
      <div class="mt-[25px]">
        In this category, photographers turn fashion and beauty into art, capturing<br>
        trends and personal style through expert composition.
      </div>
    </div>
    ...
    <!-- Cột bên phải -->
    <a href="https://unsplash.com/photos/a-woman-wearing-a-black-hat-and-a-black-jacket-AxClQ2pAM2M">
      <div
