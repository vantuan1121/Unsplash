...
import info from '@/assets/img/imgmenu/Health_Wellness/info.avif';
...
<template>
  ...
  <div class="flex justify-center gap-7">
    ...
    <div class="mt-[50px] border-0 w-[15cm]">
      ...
      <div class="mt-[25px]">
        Showcasing a healthy mind, body, and soul through photographs of medical  <br>
        discoveries, alternative medicines, healthy eating, and meditation.
      </div>
    </div>
    ...
    <!-- Cột bên phải -->
    <a href="https://unsplash.com/photos/white-and-brown-wooden-rolling-pin-pBBxMUCgwuU ">
      <div
