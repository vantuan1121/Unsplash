...
import info from '@/assets/img/imgmenu/Food_Drink/info.avif';
</script>
...
<template>
  ...
  <div class="flex justify-center gap-7">
    ...
    <div class="mt-[50px] border-0 w-[15cm]">
      ...
      <div class="mt-[25px]">
        Food and drink take center stage in this category, where photographers<br>
        transform meals and beverages into captivating works of art.
      </div>
    </div>
    ...
    <!-- Cột bên phải -->
    <a href="https://unsplash.com/photos/a-cup-of-tea-and-some-lemons-on-a-table-NDDbOaluXLQ">
      <div
