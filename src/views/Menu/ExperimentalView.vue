...
import info from '@/assets/img/imgmenu/Experimental/info.avif';
...
<template>
  ...
  <div class="flex justify-center gap-7">
    ...
    <div class="mt-[50px] border-0 w-[15cm]">
      ...
      <div class="mt-[25px]">
        The Experimental category invites photographers to explore new techniques<br>
        and perspectives and push creative boundaries.
      </div>
    </div>
