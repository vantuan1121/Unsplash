...
import info from '@/assets/img/imgmenu/Animals/info.avif';
</script>
...
<template>
  ...
  <div class="flex justify-center gap-7">
    ...
    <div class="mt-[50px] border-0 w-[15cm]">
      ...
      <div class="mt-[25px]">
        Capturing the beauty, behaviour and diversity of animals, this category<br>
        celebrates the wonders of the animal kingdom.
      </div>
    </div>
