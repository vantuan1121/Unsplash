...
import info from '@/assets/img/imgmenu/Sports/info.avif';
</script>
...
<template>
  ...
  <div class="flex justify-center gap-7">
    ...
    <div class="mt-[50px] border-0 w-[15cm]">
      ...
      <div class="mt-[25px]">
        This category captures the thrill of sports, highlighting victory, camaraderie, and<br>
        the intense emotion and dedication of athletes.
      </div>
    </div>
    ...
    <!-- Cột bên phải -->
    <a href="https://unsplash.com/photos/a-group-of-people-riding-skis-down-a-snow-covered-slope-M49npbiWgAc">
      <div
